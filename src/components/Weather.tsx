    ...
    return (
        <section className={'section'}>
           <div className="container">
               <h1 style={{marginBottom: 50}} className={'title has-text-centered'}>{data.name} - {data.sys.country}</h1>
                   ...
                   <div className="level-item has-text-centered">
                       <div>
                           ...
                           <div className={'title'}>
                               ...
                               <p className="mb-2">{fahrenheit}<sup>K</sup></p>
                               <p className="mb-2">{celsius}<sup>C</sup></p>
                           </div>
                       </div>
                   </div>
                   <div className={'level-item has-text-centered'}>
